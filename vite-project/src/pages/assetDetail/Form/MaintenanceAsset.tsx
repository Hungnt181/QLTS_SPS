import {
    ...
    DialogSurface,
    DialogTitle,
    DialogTrigger, Field, Label, Select, Textarea
...
const MaintenanceAsset = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        taiSan: {
            ...
            hanBaoDuong: asset?.hanBaoDuong,
            trangThai: "Đang bảo dưỡng",
        },
        ngayBaoDuong: `${new Date().toLocaleDateString("vi-VN")}`,
            ...
            if (foundAsset) {
                ...
                setFormData({
                    ...
                    taiSan: {
                        ...
                        hanBaoDuong: foundAsset.hanBaoDuong,
    ...
    const addNewItem = async () => {
        const data = localStorage.getItem('data');
        const allData = data ? JSON.parse(data) : {maintenanceAsset: []};
        allData.maintenanceAsset.push(
            formData
        );
            ...
            <Dialog open={true}>
                <DialogSurface className={style2.formAddSettingWitdh}>
                    <DialogBody className={style2.formAddSettingMaster}>
                        <DialogTitle>Bảo dưỡng tài sản</DialogTitle>
                        <DialogContent>
                            <Accordion
                                openItems={openItems}
                            ...
                            >
                                            ...
                                            <div className={style.formDiv}>
                                                ...
                                                <div className={style3.itemInfo}>
                                                    <div className={style3.itemInfoIcon}>
                                                        ...
                                                        <span>Hạn bảo dưỡng</span>
                                                    </div>
                                                    <Text>{asset?.hanBaoDuong}</Text>
                                                </div>
                                ...
                                <AccordionItem value="2">
                                    ...
                                    <AccordionPanel className={style.formContent}>
                                        ...
                                        <div>
                                            <div className={style.formDiv}>
                                                <Field label="Ngày bảo dưỡng" className={style.formLabel}>
                                                    <DatePicker
                                                        className={style.formInput}
                                                        placeholder="Chọn ngày bảo dưỡng tài sản"
                                                        id={"ngayBaoDuong"}
                                                        name={"ngayBaoDuong"}
                                                        onSelectDate={handleDateChange("ngayBaoDuong")}
                                                    />
                                                </Field>
                                            </div>
                                            <div className={style.formDiv}>
                                                <Label size="medium" htmlFor={"loaiBaoDuong"}
                                                       className={style.formLabel}>
                                                    Loại bảo dưỡng
                                                </Label>
                                                <Select id={"loaiBaoDuong"} name={"loaiBaoDuong"}
                                                        className={style.formInput}
